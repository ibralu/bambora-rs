...
/// struct for typed errors of method [`reports_post`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ReportsPostError {
...
pub async fn reports_post(configuration: &configuration::Configuration, search_query: Option<crate::models::SearchQuery>) -> Result<crate::models::SearchResult, Error<ReportsPostError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReportsPostError> = serde_json::from_str(&local_var_content).ok();
